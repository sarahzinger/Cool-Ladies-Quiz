$(document).ready(function(){
	...
	people.push(new Person("harriet", "Harriet Tubman","\"Every great dream begins with a dreamer. Always remember, you have within you the strength, the patience, and the passion to reach for the stars to change the world.\"", "<iframe src=\"http://en.wikipedia.org/wiki/Harriet_Tubman\"></iframe>"));
